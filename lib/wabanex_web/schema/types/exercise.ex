defmodule WabanexWeb.Schema.Types.Exercise do
  ...
  input_object :create_exercise_input do
    ...
    field :protocol_description, non_null(:string), description: "Exercise description"
    field :repetitions, non_null(:string), description: "Exercise number of repetitions"
    field :youtube_video_url, non_null(:string), description: "Exercise demonstration video URL"
  end
end
